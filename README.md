...
main.tf — Complete Terraform HCL with provider, VPC, EC2/EKS, RDS, IAM, security groups
deployment.yaml — Kubernetes Deployments, Services, HPA, Ingress with health checks
Architecture diagram — ASCII visual map of all components and connections
.github/workflows/deploy.yml — Full GitHub Actions CI/CD pipeline
